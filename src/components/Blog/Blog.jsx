...
const Blog = ({blog, handleBookMarks, handleMarksRead}) => {
    const {id,title, coverImg, author, readingTimes, postedDate, hashtags} = blog;
    ...
    return (
        <div className='mb-16 space-y-4'>
            ...
            <div>
               <button className='text-purple-700 underline' onClick={() => handleMarksRead(id, readingTimes)}>Mark As Read</button>
            </div>
        </div>
    );
};
